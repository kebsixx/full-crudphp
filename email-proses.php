...
$mail->Username   = 'rizieqanw@gmail.com';         //SMTP username
$mail->Password   = 'rgzq epul eokr oeyn';         //SMTP password
$mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;   //Enable implicit TLS encryption
$mail->Port       = 465;

// check apakah tombol kirim ditekan
//Recipients
$mail->setFrom('rizieqanw@gmail.com', 'rizieq');
$mail->addAddress($_POST['email_penerima']);     //Add a recipient
$mail->addReplyTo('rizieqanw@gmail.com', 'test');
